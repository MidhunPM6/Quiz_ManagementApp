...
const Signup = () => {
  return (
    ...
    <div className="flex place-content-center ml-12">
      <div className="flex flex-col place-items-center  h-[70vh]  font-poppins">
        ...
        >
          ...
          <input
            ...
            className="py-1 px-10 mt-10 border-2 rounded-md border-gray-200 focus:outline-gray-300"
          />
      ...
      <div >
        <button className="mt-10 text-md font-bold bg-slate-100 text-gray-700  px-6 py-1 rounded-md hover:bg-slate-200">Login</button>
      </div>
